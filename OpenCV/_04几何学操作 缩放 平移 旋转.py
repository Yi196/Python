...
# 镜像
img_changed = cv.flip(img, 0)  # 镜像  flipCode= -1 旋转180度  0 垂直镜像 1 水平镜像

# 顺时针、逆时针旋转90度（无黑边）
img_t = cv2.transpose(img)    # 行列互换
img_90 = cv2.flip(img_t, 1)   # 顺时针转90度
img_m90 = cv2.flip(img_t, 0)  # 逆时针转90度
...
if __name__ == '__main__':
    def show_1(img_1):
        ...
        plt.show()
    for img_1 in [img1, img2, img3, img4, img5, img6, img7, img8, img_90, img_m90]:
        show_1(img_1)
